...
export default class HomeScreen extends Component {
  ...
  getArticle = () => {
    const url = "https://e1c6-49-207-216-200.ngrok.io/get-article";
    axios
      .get(url)
      .then(response => {
  ...
  likedArticle = () => {
    const url = "https://e1c6-49-207-216-200.ngrok.io/liked-article";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
  ...
  unlikedArticle = () => {
    const url = "https://e1c6-49-207-216-200.ngrok.io/unliked-article";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
